// leave off @2x/@3x
const ElementStatusImages = {
  Dragon: require('./images/elements/DragonBlight.png'),
  Fire: require('./images/elements/FireBlight.png'),
  Ice: require('./images/elements/IceBlight.png'),
  Thunder: require('./images/elements/ThunderBlight.png'),
  Water: require('./images/elements/WaterBlight.png'),
  Sever: require('./images/weapons/1.png'),
  Blunt: require('./images/weapons/Hammer_Icon_White.png'),
  Shot: require('./images/weapons/Heavy_Bowgun_Icon_White.png'),
  Stun: require('./images/aliments/Stun.png'),
  Extract: require('./images/weapons/Insect_Glaive_Icon_White.png'),
